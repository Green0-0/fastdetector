...
def main():
    ...
    parser.add_argument("--columns", nargs='+', required=True, help="List of base column names (e.g., 'original', 'final_response').")
    ...
    for col_a, col_b in itertools.combinations(args.columns, 2):
        ...
        if args.pairwise_cosim:
            ...
            res = pairwise_cossim(emb_a, emb_b)
            ds = ds.add_column(f"pairwise_cossim_{col_a}_{col_b}", res)
