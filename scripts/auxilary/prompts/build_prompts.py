...
def main():
    ...
    ], "direct_reference_dataset", "direct_reference", target_size=500, max_stack=1)
    ...
    ], "revise_dataset", "revise", target_size=1500, max_stack=2)
    ...
    }, "indirect_reference_dataset", "indirect_reference", target_size=500)
