...
def batch_gen_embeddings(texts: list[str], model_name: str = "Alibaba-NLP/gte-modernbert-base", batch_size: int = 32) -> np.ndarray:
...
def batch_cross_encoder(texts_a: list[str], texts_b: list[str], model_name: str = "Alibaba-NLP/gte-reranker-modernbert-base", batch_size: int = 4) -> list[float]:
